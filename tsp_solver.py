...
def main():
    ...
    parser.add_argument("--file", "-f", default="data/rl11849.tsp", help="TSP file instance name to solve (in data folder) (ex) data/a280.tsp")
    # 2-opt Algorithm
    ...
    parser.add_argument("--fitness_limit", "-limit", type=float, default=math.inf, help="fitness function limits")
    ...
    if args.method == "Greedy":
        ...
        parameters = "population: %d, fitness limit: %f" % (args.population_size, args.fitness_limit)
...
def parse_data(file_path):
    ...
    try:
        ...
        distances = [
            [math.hypot(coordinates[i][0] - coordinates[j][0], coordinates[i][1] - coordinates[j][1]) for j in range(cl)] for i in range(cl)
        ]
